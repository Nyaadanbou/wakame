...
class HasPaidMarketNetworkTax(
    ...
    override fun check(profile: Profile): Boolean {
        ...
        return TownyLocal.hasPaidMarketNetworkTax(government)
    }
}

class HasPaidMarketNetworkTaxFactory(
    ...
    override fun parsePlayer(instruction: Instruction): PlayerCondition {
        ...
        return HasPaidMarketNetworkTax(logger, govType)
    }
}