...
interface Teleport : Skill {
    ...
    private class DefaultImpl(
        ...
        override fun cast(context: SkillCastContext): SkillCastResult {
            val player = context.optional(SkillCastContextKey.CASTER_PLAYER) ?: return FixedSkillCastResult.NONE_CASTER
            val location = context.optional(SkillCastContextKey.TARGET_LOCATION)?.bukkitLocation ?: return FixedSkillCastResult.NONE_TARGET
            when (val type = type) {
                is Type.FIXED -> {
