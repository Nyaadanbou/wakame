...
import cc.mewcraft.wakame.catalog.enchantment.EnchantableTagEntry
...
internal class CatalogEnchantmentByTypeResultMenu(
    val viewer: Player,
    val tagEntry: EnchantableTagEntry,
) : CatalogEnchantmentMenu {

    private val settings: BasicMenuSettings = CatalogEnchantmentMenuSettings.getMenuSettings("by_type_result")
