...
internal object PacketIdRegistry {
    ...
    val PLAY_SERVERBOUND_DEBUG_SUBSCRIPTION_REQUEST = SERVERBOUND_PACKET_IDS.getInt(GamePacketTypes.SERVERBOUND_DEBUG_SUBSCRIPTION_REQUEST)
    ...
    val PLAY_CLIENTBOUND_MOUNT_SCREEN_OPEN = CLIENTBOUND_PACKET_IDS.getInt(GamePacketTypes.CLIENTBOUND_MOUNT_SCREEN_OPEN)
