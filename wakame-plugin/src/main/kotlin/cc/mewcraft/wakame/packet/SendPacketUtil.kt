...
object SendPacketUtil {
    fun sendPlayerPotionEffect(player: Player, effect: PotionEffect) {
    ...
    fun removePlayerPotionEffect(player: Player, effectType: PotionEffectType) {
        val user = PacketEvents.getAPI().playerManager.getUser(player)
