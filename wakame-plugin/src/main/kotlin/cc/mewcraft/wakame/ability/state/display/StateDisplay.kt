...
import cc.mewcraft.wakame.ability.AbilitySupport
...
class PlayerStateDisplay : StateDisplay<Player> {
    private val triggerNames: Map<Trigger, String> by AbilitySupport.GLOBAL_STATE_DISPLAY_CONFIG.entry("triggers")

    private val playerConfig = AbilitySupport.GLOBAL_STATE_DISPLAY_CONFIG.node("player_state")
