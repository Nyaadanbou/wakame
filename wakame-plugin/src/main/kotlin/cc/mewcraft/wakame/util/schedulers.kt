...
import cc.mewcraft.wakame.KoishPluginProvider
...
fun runTask(run: () -> Unit): BukkitTask {
    return Bukkit.getScheduler().runTask(KoishPluginProvider.get(), run)
}
...
fun runTaskSelfAware(run: (task: BukkitTask) -> Unit) {
    Bukkit.getScheduler().runTask(KoishPluginProvider.get(), run)
}
...
fun runTaskLater(delay: Long, run: () -> Unit): BukkitTask {
    return Bukkit.getScheduler().runTaskLater(KoishPluginProvider.get(), run, delay)
}
...
fun runTaskLaterSelfAware(delay: Long, run: (task: BukkitTask) -> Unit) {
    Bukkit.getScheduler().runTaskLater(KoishPluginProvider.get(), run, delay)
}
...
fun runTaskTimer(delay: Long, period: Long, run: () -> Unit): BukkitTask {
    return Bukkit.getScheduler().runTaskTimer(KoishPluginProvider.get(), run, delay, period)
}
...
fun runTaskTimerSelfAware(delay: Long, period: Long, run: (task: BukkitTask) -> Unit) {
    Bukkit.getScheduler().runTaskTimer(KoishPluginProvider.get(), run, delay, period)
}
...
fun runAsyncTask(run: () -> Unit): BukkitTask {
    return Bukkit.getScheduler().runTaskAsynchronously(KoishPluginProvider.get(), run)
}
...
fun runAsyncTaskSelfAware(run: (task: BukkitTask) -> Unit) {
    Bukkit.getScheduler().runTaskAsynchronously(KoishPluginProvider.get(), run)
}
...
fun runAsyncTaskLater(delay: Long, run: () -> Unit): BukkitTask {
    return Bukkit.getScheduler().runTaskLaterAsynchronously(KoishPluginProvider.get(), run, delay)
}
...
fun runAsyncTaskLaterSelfAware(delay: Long, run: (task: BukkitTask) -> Unit) {
    Bukkit.getScheduler().runTaskLaterAsynchronously(KoishPluginProvider.get(), run, delay)
}
...
fun runAsyncTaskTimer(delay: Long, period: Long, run: () -> Unit): BukkitTask {
    return Bukkit.getScheduler().runTaskTimerAsynchronously(KoishPluginProvider.get(), run, delay, period)
}
...
fun runAsyncTaskTimerSelfAware(delay: Long, period: Long, run: (task: BukkitTask) -> Unit) {
    Bukkit.getScheduler().runTaskTimerAsynchronously(KoishPluginProvider.get(), run, delay, period)
}
