...
class EntityMeleeAttackMetadata(
    ...
    init {
        ...
        this.criticalPower = attributeMap.getValue(Attributes.CRITICAL_STRIKE_POWER)
        this.isCritical = Random.nextDouble() < attributeMap.getValue(Attributes.CRITICAL_STRIKE_CHANCE)
    }
}
