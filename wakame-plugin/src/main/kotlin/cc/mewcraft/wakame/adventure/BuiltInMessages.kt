...
object BuiltInMessages {
    ...
    val STARTUP_BANNER: Args0 = Args0 {
        val infoLine1: Component = Component.text()
            .append(Component.text(KoishBootstrapContexts.PLUGIN_NAME, PRIMARY_COLOR))  // 使用主色
            .appendSpace()
            .append(Component.text("v${KoishBootstrapContexts.PLUGIN_VERSION}", SECONDARY_COLOR))  // 使用次色
            .build()
