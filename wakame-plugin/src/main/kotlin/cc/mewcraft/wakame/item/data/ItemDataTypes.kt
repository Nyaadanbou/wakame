...
import cc.mewcraft.wakame.item.mixin.ItemKey
...
data object ItemDataTypes {
    ...
    @JvmField
    val ONLY_COMPARE_TYPE_ID_IN_RECIPE_BOOK: ItemDataType<Unit> = typeOf("only_compare_type_id_in_recipe")
     ...
     *
     * @see createItemDataContainerCodec
     */
