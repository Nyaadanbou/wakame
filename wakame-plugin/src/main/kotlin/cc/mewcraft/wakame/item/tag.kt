...
internal object KoishTagApiBootstrap {
    @InitFun
    fun init() {
 ...
 * 该系统目的是类比原版的物品标签系统, 同时支持原版物品, Koish 物品, 甚至第三方物品的匹配.
 *
 * 在合成系统使用举例:
 ...
 */
object KoishTagManager : KoishTagManagerApi {
    ...
    override fun isTagged(itemStack: ItemStack, tagId: KoishKey): Boolean {
        return map[tagId]?.contains(ItemRef.create(itemStack)) == true
    }
