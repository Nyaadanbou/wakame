...
data class ItemRarity(
    ...
    companion object : ItemComponentBridge<ItemRarity>, ItemComponentMeta {
        ...
        override val configPath: String = ItemConstants.RARITY
        override val tooltipKey: TooltipKey = ItemConstants.createKey { RARITY }
    ...
    override fun provideTooltipLore(systemName: RendererSystemName): LoreLine {
        ...
        val rendered = tooltip.render(systemName, Placeholder.component("value", rarity.displayName)) ?: return LoreLine.noop()
