 ...
 */
sealed interface ItemDataContainer : ServerItemDataContainer {
    companion object {
        internal fun codec(): Codec<ServerItemDataContainer> {
            return createItemDataContainerCodec()
        }

        fun empty(): ItemDataContainer {
            return EmptyItemDataContainer
        }
...
private fun createDirectSerializers(): TypeSerializerCollection {
    val serials = TypeSerializerCollection.builder()
...
private open class SimpleItemDataContainer(
    ...
    override fun build(): ItemDataContainer {
        return if (dataMap.isEmpty()) EmptyItemDataContainer else this
    }
