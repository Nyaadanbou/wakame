...
import cc.mewcraft.wakame.item.display.implementation.standard.AttributeCoreTextMetaFactory
...
internal data class RerollingDifferenceFormats(
     ...
     * @return 基于 [id], [source], [context] 生成的 [IndexedText]
     */
...
internal data class CoreAttributeRendererFormat(
    ...
    /**
     * 实现要求: 返回值必须是 [cc.mewcraft.wakame.item.display.implementation.standard.AttributeCoreTextMeta.derivedIndexes] 的子集.
     */
...
internal data class CoreEmptyRendererFormat(
    ...
    override val textMetaFactory: TextMetaFactory = CyclicTextMetaFactory(namespace, id, CyclicIndexRule.Shared.SLASH)
