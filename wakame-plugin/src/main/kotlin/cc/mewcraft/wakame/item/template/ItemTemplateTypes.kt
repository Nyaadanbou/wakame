...
object ItemTemplateTypes {
     ...
     */
    @JvmField
    val SLOT_DISPLAY_LORE: ItemTemplateType<ItemSlotDisplayLore> = ItemSlotDisplayLore.codec(ItemConstants.SLOT_DISPLAY_LORE).register()

    /**
     * 组件: n/a
     */
    @JvmField
    val SLOT_DISPLAY_NAME: ItemTemplateType<ItemSlotDisplayName> = ItemSlotDisplayName.codec(ItemConstants.SLOT_DISPLAY_NAME).register()
