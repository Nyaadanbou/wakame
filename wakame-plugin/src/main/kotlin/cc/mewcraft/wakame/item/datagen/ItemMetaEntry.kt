...
import cc.mewcraft.wakame.item.mixin.getDataContainerOrDefault
...
interface ItemMetaEntry<V> {
     ...
     */
    context(_: ItemMetaEntry<V>)
    fun <T> MojangStack.ensureSetData(type: ItemDataType<in T>, value: T): T? {
        val container = getDataContainerOrDefault(ItemDataContainer.empty())
