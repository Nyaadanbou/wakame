...
internal class Vitality : AbstractEnchantment(Enchantments.VITALITY) {
    private val component1: EnchantmentAttributeComponent = EnchantmentAttributeComponent(this, setOf(Part(Attributes.MAX_HEALTH, 0.05, 0.05, Operation.MULTIPLY_TOTAL)))
