...
internal class Quake : AbstractEnchantment(Enchantments.QUAKE) {
    private val component1: EnchantmentAttributeComponent = EnchantmentAttributeComponent(this, setOf(Part(Attributes.HAMMER_DAMAGE_RANGE, 0.5, 0.3, AttributeModifier.Operation.ADD)))
