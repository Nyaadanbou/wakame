...
internal class Agility : AbstractEnchantment(Enchantments.AGILITY) {
    private val component1: EnchantmentAttributeComponent = EnchantmentAttributeComponent(this, setOf(EnchantmentAttributeComponent.Part(Attributes.MOVEMENT_SPEED, 0.05, 0.05, Operation.MULTIPLY_TOTAL)))
