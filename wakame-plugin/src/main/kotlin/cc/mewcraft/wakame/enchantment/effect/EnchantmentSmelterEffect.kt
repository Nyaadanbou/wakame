    ...
    companion object {
        ...
        val CODEC: Codec<EnchantmentSmelterEffect> = RecordCodecBuilder.create { instance ->
            instance.group(
                ...
                AdventureCodecs.KEY_WITH_MINECRAFT_NAMESPACE.fieldOf("sound").forGetter(EnchantmentSmelterEffect::sound),
                PaperCodecs.MATERIAL_ITEM.setOf().fieldOf("exempted_items").forGetter(EnchantmentSmelterEffect::exemptedItems)
