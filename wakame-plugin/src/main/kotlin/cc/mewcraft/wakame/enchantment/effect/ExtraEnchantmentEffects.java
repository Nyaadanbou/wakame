...
import cc.mewcraft.wakame.mixin.InvokerEnchantmentEffectComponents;
...
/// 负责注册新的 [net.minecraft.world.item.enchantment.EnchantmentEffectComponents].
///
/// 程序上, 这些类型是纯粹的数据类型. 这些类型也许会包含一些逻辑, 但这些逻辑最终是要被魔咒的框架调用.
/// 这些数据类型可以通过原版的数据包来创建, 然后便可以通过 [Enchantment#effects()] 来访问.
///
...
/// }
/// ```
public class ExtraEnchantmentEffects {
    /// 提供自定义属性.
