...
internal class DeepSearch : AbstractEnchantment(Enchantments.DEEP_SEARCH) {
    private val component1: EnchantmentAttributeComponent = EnchantmentAttributeComponent(this, setOf(EnchantmentAttributeComponent.Part(Attributes.BLOCK_INTERACTION_RANGE, 1.0, 0.5, Operation.ADD)))
