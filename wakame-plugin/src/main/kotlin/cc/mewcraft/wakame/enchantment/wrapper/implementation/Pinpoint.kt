...
internal class Pinpoint : AbstractEnchantment(Enchantments.PINPOINT) {
    private val component1: EnchantmentAttributeComponent = EnchantmentAttributeComponent(this, setOf(Part(Attributes.CRITICAL_STRIKE_CHANCE, 0.05, 0.05, Operation.ADD)))
