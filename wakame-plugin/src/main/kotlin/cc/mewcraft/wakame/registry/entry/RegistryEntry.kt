...
/**
 * 用于持有数据的容器, 附加了专用于跟 [cc.mewcraft.wakame.registry.Registry] 进行交互的函数.
 *
 * @see cc.mewcraft.wakame.registry.Registry
 */
interface RegistryEntry<T> {
     ...
     *
     * 该键名包含两种信息:
     * 1. 该容器 [RegistryEntry] 所在的注册表 [cc.mewcraft.wakame.registry.Registry]
     * 2. 该容器 [RegistryEntry] 在 [cc.mewcraft.wakame.registry.Registry] 中的位置
     *
    ...
    private constructor(
        ...
        enum class Type {
            /**
             * 由注册表自己使用 [cc.mewcraft.wakame.registry.WritableRegistry.add] 创建的 [Reference].
             */
            STANDALONE,

            /**
             * 由外部调用 [cc.mewcraft.wakame.registry.Registry.createEntry] 创建的 [Reference].
             */
            INTRUSIVE
        }
    }
