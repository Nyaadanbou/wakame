...
import cc.mewcraft.wakame.item.property.impl.CraftingRemainderType
...
object BuiltInRegistryKeys {
    ...
    @JvmField
    val ITEM_PROXY = createRegistryKey<ProxyKoishItem>("item_proxy")
    ...
    @JvmField
    val CRAFTING_REMINDER_TYPE = createRegistryKey<CraftingRemainderType>("crafting_reminder_type")
