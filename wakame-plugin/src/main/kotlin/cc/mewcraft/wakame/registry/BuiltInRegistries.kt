...
import cc.mewcraft.wakame.item.data.impl.CoreTypes
...
object BuiltInRegistries {
     ...
     */
    @JvmField
    val ITEM_PROXY: WritableRegistry<ProxyKoishItem> = registerSimple(BuiltInRegistryKeys.ITEM_PROXY)
     ...
     */
    @JvmField
    val ITEM_BEHAVIOR: WritableRegistry<ItemBehavior> = registerSimple(BuiltInRegistryKeys.ITEM_BEHAVIOR)
     ...
     */
    @JvmField
    val CRAFTING_REMAINDER_TYPE: WritableRegistry<CraftingRemainderType> = registerSimple(BuiltInRegistryKeys.CRAFTING_REMINDER_TYPE) { CraftingRemainderTypes }
