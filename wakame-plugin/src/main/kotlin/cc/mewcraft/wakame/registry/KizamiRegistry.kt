...
@PreWorldDependency(runBefore = [SkillInstanceRegistry::class, AttributeRegistry::class])
@ReloadDependency(runBefore = [SkillInstanceRegistry::class, AttributeRegistry::class])
