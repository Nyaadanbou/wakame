...
object FamilyDefinitions {
    ...
    val BUKKIT_ENTITY: Family = family { all(BukkitEntityComponent, BukkitBridgeComponent, WithAbility) }
    ...
    val PLAYER: Family = family { all(PlayerComponent, BukkitBridgeComponent, WithAbility) }
}