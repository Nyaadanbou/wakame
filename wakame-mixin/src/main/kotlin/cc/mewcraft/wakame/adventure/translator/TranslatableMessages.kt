...
object TranslatableMessages {
    ...
    val MSG_HOLD_LAST_DAMAGE_DEFAULT_WHEN_USE = create("msg_hold_last_damage_default_when_use")
    val MSG_HOLD_LAST_DAMAGE_DEFAULT_WHEN_ATTACK = create("msg_hold_last_damage_default_when_attack")
