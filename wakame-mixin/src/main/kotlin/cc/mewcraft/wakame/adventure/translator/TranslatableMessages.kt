...
object TranslatableMessages {
    ...
    val MSG_ERR_CANNOT_USE_CROSSBOW_IN_OFFHAND = create("msg_err_cannot_use_crossbow_in_offhand")
    val MSG_ERR_CANNOT_USE_TRIDENT_IN_OFFHAND = create("msg_err_cannot_use_trident_in_offhand")
    ...
    val MSG_ERR_CANNOT_USE_TELEPORT_ANCHOR_IN_CURRENT_SERVER = create("msg_err_cannot_use_teleport_anchor_in_current_server")
    ...
    val MSG_ERR_SIGN_IN_NOT_AVAILABLE = create("msg_err_sign_in_not_available")
