...
object TranslatableMessages {
    ...
    val MSG_USE_BOW_IN_OFFHAND = create("msg_use_bow_in_offhand")
    val MSG_USE_CROSSBOW_IN_OFFHAND = create("msg_use_crossbow_in_offhand")
    val MSG_USE_TRIDENT_IN_OFFHAND = create("msg_use_trident_in_offhand")
