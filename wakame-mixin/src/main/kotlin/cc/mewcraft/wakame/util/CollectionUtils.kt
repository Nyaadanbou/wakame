...
object CollectionUtils {
    ...
    /**
     * Sorts the given [collection] by their [beforeThisMapper] and
     * [afterThisMapper] properties.
     *
     * @param collection The collection to sort.
     * @param beforeThisMapper A function that returns a set of elements that
     *     should be before the given element.
     * @param afterThisMapper A function that returns a set of elements that
     *     should be after the given element.
     * @throws IllegalArgumentException If the collection contains a circular
     *     dependency.
     */
