...
class KoishMessagingManager(
    ...
    companion object {
        ...
        private lateinit var instance: KoishMessagingManager

        /**
         * 初始化全局 [KoishMessagingManager] 实例.
         */
        fun init(config: MessagingConfig) {
            instance = KoishMessagingManager(config)
        }
    ...
    fun start() {
        ...
        handler.addHandler(KoishMessagingHandler(this.serverId, this.packetService))
