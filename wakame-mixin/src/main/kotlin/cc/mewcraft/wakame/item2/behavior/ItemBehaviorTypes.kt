...
import cc.mewcraft.wakame.item2.behavior.impl.external.BrewRecipe
...
object ItemBehaviorTypes {
     ...
     *
     * @see cc.mewcraft.wakame.item2.config.property.ItemPropTypes.HOLD_LAST_DAMAGE
     */
    @JvmField
     ...
     * 作为一般近战武器的逻辑, 如斧等.
     *
     * @see cc.mewcraft.wakame.item2.config.property.ItemPropTypes.MELEE
     */
    @JvmField
     ...
     * 物品具有该行为时, 可以作为双剑武器.
     *
     * @see cc.mewcraft.wakame.item2.config.property.ItemPropTypes.DUAL_SWORD
     */
    @JvmField
     ...
     * 物品具有该行为时, 可以作为太刀武器.
     *
     * @see cc.mewcraft.wakame.item2.config.property.ItemPropTypes.KATANA
     */
    @JvmField
     ...
     * 物品具有该行为时, 可以捕捉和释放生物.
     *
     * @see cc.mewcraft.wakame.item2.data.ItemDataTypes.ENTITY_BUCKET_DATA
     * @see cc.mewcraft.wakame.item2.data.ItemDataTypes.ENTITY_BUCKET_INFO
     * @see cc.mewcraft.wakame.item2.config.property.ItemPropTypes.ENTITY_BUCKET
     */
    @JvmField
     ...
     * 需要安装对应插件才能正常使用.
     *
     * @see cc.mewcraft.wakame.item2.data.ItemDataTypes.BREW_RECIPE
     */
    @JvmField
     ...
     * 需要安装对应插件才能正常使用.
     *
     * @see cc.mewcraft.wakame.item2.config.property.ItemPropTypes.PLACE_BLOCK
     */
    @JvmField
     ...
     * 需要安装对应插件才能正常使用.
     *
     * @see cc.mewcraft.wakame.item2.config.property.ItemPropTypes.PLACE_LIQUID_COLLISION_BLOCK
     */
    @JvmField
     ...
     * 需要安装对应插件才能正常使用.
     *
     * @see cc.mewcraft.wakame.item2.config.property.ItemPropTypes.PLACE_DOUBLE_HIGH_BLOCK
     */
    @JvmField
