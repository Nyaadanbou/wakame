...
fun <T> MojangStack.getProperty(type: ItemPropertyType<out T>): T? = TODO("#350")

fun <T> MojangStack.hasProperty(type: ItemPropertyType<T>): Boolean = getProperty(type) != null
